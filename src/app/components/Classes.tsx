...
export default function Classes() {
    ...
    return (
        <div
            className="relative bg-[#fdfbf9] bg-cover bg-center bg-no-repeat py-16 px-6 text-center"
        ...
        >
            <motion.div {...fadeInUp}>
                <div className="relative z-10 max-w-5xl mx-auto">
                    ...
                    {/* Párrafo: Destacado pero contenido (Tamaño de frase de impacto) */}
                    <p className="max-w-2xl mx-auto leading-snug font-body font-medium text-neutral-700 text-3xl md:text-4xl">
