...
import ContactModal from "@/app/components/ContactModal"; // Asegúrate de que la ruta sea correcta
...
const content = {
  en: {
    ...
    serviceValue: "Private Classes", // Valor para el select del modal
  },
  es: {
    ...
    serviceValue: "Clases Privadas", // Valor para el select del modal
  },
};
